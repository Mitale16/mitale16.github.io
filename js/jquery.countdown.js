...
function Countdown() {
	...
	this._defaults = {
		until: new Date(2020, 1 - 1, 1, 0, 0, 0), // new Date(year, mth - 1, day, hr, min, sec) - date/time to count down to
		...
		expiryText: 'Thank-You', // Text to display upon expiry, replacing the countdown
